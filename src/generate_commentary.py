...
# Loaded from src/prompts/commentary_system_v1.md so prompt evolution shows up
# in PR diffs alongside code changes. Body is byte-identical to the previous
# inline string literal — see tests/test_prompts.py for substring assertions.
_SYSTEM_PROMPT = load_prompt("commentary_system_v1")
